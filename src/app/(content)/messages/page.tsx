...
const messages = [
  ...
  {
    id: 3,
    content: "Don't forget the meeting at 2 PM",
    date: "2023-05-03",
    author: "Charlie",
    cringe: false,
  },
...
export default function MessagesPage() {
  ...
  const filteredMessages = messages?.filter((message) => {
    ...
    const matchesSearch = message.message_content
      ?.toLowerCase()
  ...
  return (
    <div className="container mx-auto py-10">
      ...
      <div className="mb-6 ml-4 flex flex-wrap items-end gap-4">
        <div>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                variant="outline"
                className="ml-2 w-[130px] justify-start pl-2.5 text-left font-normal text-black"
              >
          ...
          <Select value={author} onValueChange={setAuthor}>
            ...
            <SelectContent>
              ...
              {uniqueAuthors?.map((author) => (
                <SelectItem key={author.discord_id} value={author.discord_id}>
        ...
        <TableBody>
          {filteredMessages?.map((message) => (
            <TableRow key={message.snowflake}>
              ...
              <TableCell>
                {
                  viewFilter?.find((e) => e.discord_id == message.posted_by)
                    ?.discord_username
                }
              </TableCell>
